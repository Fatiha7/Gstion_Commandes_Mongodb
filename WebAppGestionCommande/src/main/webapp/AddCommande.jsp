...
<div class="container mt-5 mb-5">
    <div class="row d-flex justify-content-center">
		...
		<form method="POST" action="AddCommandeServletEx">
			...
			<fieldset  ><!-- disabled -->
					...
					<input type="text"  name="nom" class="form-control col" placeholder="nom de Client"/>	
					<label for="Prenom" class="h5 col-2">Prenom:</label>
					<input  type="text" name="prenom" class="form-control col" placeholder="Prenom"/>
					
					</div>
					<br>
					<div class="half-width row ">
					<label for="Adresse" class="h5 col-2">Adresse:</label>
					<input type="text" name="adresse" class="form-control col" placeholder="Adresse"/>
					<label for="Phone" class="h5 col-2">Phone:</label>
					<input type="text" name="Phone" class="form-control col" placeholder="Phone"/>
					</div>
				...
				<br><br>	
					...
					<span class="cd-select ">
									...
									<option class="form-control ">select Produit</option>
							<%
					...
					<input type="text" name="quantite" class="form-control col" placeholder="Quantite"/>
					</div></div>
					<br><br><br>
